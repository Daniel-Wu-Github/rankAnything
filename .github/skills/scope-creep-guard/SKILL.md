...
1. Respect phase boundaries in planning docs and source-of-truth docs.
2. Earlier phases must not silently implement later-phase enforcement or automation behavior.
3. Public-facing hardening reminders may be added as TODO annotations, but later-phase behavior changes must remain deferred.
4. For planning-only phases, limit edits to planning/logging/instruction surfaces unless explicitly authorized otherwise.
